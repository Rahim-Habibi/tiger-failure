...
#ifndef TIGERHYDRAULICPOINTBOUNDARY
#define TIGERHYDRAULICPOINTBOUNDARY
 ...
 */
class TigerHydraulicPointBoundary : public DiracKernel
{
public:
  static InputParameters validParams();
  TigerHydraulicPointBoundary(const InputParameters & parameters);
...
#endif // TIGERHYDRAULICPOINTBOUNDARY
