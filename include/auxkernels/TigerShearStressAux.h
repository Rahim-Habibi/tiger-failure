 ...
 * zero before dividing.  Perhaps a derived class, CheckedTigerShearStressAux,
 * could be added for people who want this feature.
 */
class TigerShearStressAux : public AuxKernel
{
public:
  static InputParameters validParams();

  TigerShearStressAux(const InputParameters & parameters);
