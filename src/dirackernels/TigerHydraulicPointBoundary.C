...
#include "TigerHydraulicPointBoundary.h"
#include "FEProblemBase.h"

registerMooseObject("TigerApp", TigerHydraulicPointBoundary);


InputParameters
TigerHydraulicPointBoundary::validParams()
{
  ...
  params.addRequiredParam<std::vector<BoundaryName>>("boundary", "The x,y,z coordinates of the "
...
TigerHydraulicPointBoundary::TigerHydraulicPointBoundary(
    const InputParameters & parameters)
  : DiracKernel(parameters),
    _mass_flux(getParam<Real>("mass_flux")),
    _p(getParam<BoundaryName>("point")),
...
void
TigerHydraulicPointBoundary::addPoints()
{
  addPoint(_p);
}

Real
TigerHydraulicPointBoundary::computeQpResidual()
{
