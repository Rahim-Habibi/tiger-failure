...
#include "TigerFrictionAux.h"

registerMooseObject("MooseApp", TigerFrictionAux);

InputParameters
TigerFrictionAux::validParams()
{
...
TigerFrictionAux::TigerFrictionAux(const InputParameters & parameters)
