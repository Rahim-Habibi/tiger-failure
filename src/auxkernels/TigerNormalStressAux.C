...
#include "TigerNormalStressAux.h"

registerMooseObject("MooseApp", TigerNormalStressAux);

InputParameters
TigerNormalStressAux::validParams()
{
...
TigerNormalStressAux::TigerNormalStressAux(const InputParameters & parameters)
  : AuxKernel(parameters), _TenMech_total_stress(getMaterialProperty<RankTwoTensor>("total_stress"))
{
}

RealVectorValue
TigerNormalStressAux::compute_normal_vector()
{
...
Real
TigerNormalStressAux::computeValue()
{
